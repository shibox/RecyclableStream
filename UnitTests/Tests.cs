...
//        {
//            Assert.Throws<ArgumentOutOfRangeException>(() => new RecyclableMemoryStreamManager<byte>(0, 100, 200));
//            Assert.Throws<ArgumentOutOfRangeException>(() => new RecyclableMemoryStreamManager<byte>(-1, 100, 200));
//            Assert.DoesNotThrow(() => new RecyclableMemoryStreamManager<byte>(1, 100, 200));
//        }

//        [Test]
//        public void RecyclableMemoryManagerThrowsExceptionOnZeroLargeBufferMultipleSize()
//        {
//            Assert.Throws<ArgumentOutOfRangeException>(() => new RecyclableMemoryStreamManager<byte>(100, 0, 200));
//            Assert.Throws<ArgumentOutOfRangeException>(() => new RecyclableMemoryStreamManager<byte>(100, -1, 200));
//            Assert.DoesNotThrow(() => new RecyclableMemoryStreamManager<byte>(100, 100, 200));
//        }

//        [Test]
//        public void RecyclableMemoryManagerThrowsExceptionOnMaximumBufferSizeLessThanBlockSize()
//        {
//            Assert.Throws<ArgumentOutOfRangeException>(() => new RecyclableMemoryStreamManager<byte>(100, 100, 99));
//            Assert.DoesNotThrow(() => new RecyclableMemoryStreamManager<byte>(100, 100, 100));
//        }

//        [Test]
//        public void RecyclableMemoryManagerThrowsExceptionOnMaximumBufferNotMultipleOfLargeBufferMultiple()
//        {
//            Assert.Throws<ArgumentException>(() => new RecyclableMemoryStreamManager<byte>(100, 1024, 2025));
//            Assert.Throws<ArgumentException>(() => new RecyclableMemoryStreamManager<byte>(100, 1024, 2023));
//            Assert.DoesNotThrow(() => new RecyclableMemoryStreamManager<byte>(100, 1024, 2048));
//        }
...
//            {
//                var memMgr = new RecyclableMemoryStreamManager<byte>(BlockSize, LargeBufferMultiple, MaxBufferSize)
...
//            var newStream = new RecyclableMemoryStream<byte>(memMgr);
...
//        {
//            var mgr = new RecyclableMemoryStreamManager<byte>();
...
//            var stream = new RecyclableMemoryStream<byte>(memoryManager);
...
//            var stream = new RecyclableMemoryStream<byte>(memoryManager, string.Empty, requestedSize);
...
//            var stream = new RecyclableMemoryStream<byte>(memMgr);
...
//            var stream2 = new RecyclableMemoryStream<byte>(memMgr);
...
//            var memoryManager = this.GetMemoryManager();
//            var stream = new RecyclableMemoryStream<byte>(memoryManager, string.Empty, expectedLength);
...
//        {
//            var tag = "Nunit test";
//            var stream = new RecyclableMemoryStream<byte>(this.GetMemoryManager(), tag);
...
//        {
//            var stream = new RecyclableMemoryStream<byte>(this.GetMemoryManager(), null);
//            var buffer = this.GetRandomBuffer(1000);
//            stream.Write(buffer, 0, buffer.Length);
//            var debugInfo = stream.ToString();
...
//        {
//            int blockSize = 10;
//            var manager = new RecyclableMemoryStreamManager<byte>(blockSize: blockSize, largeBufferMultiple: 20, maximumBufferSize: 100);
//            RecyclableMemoryStream<byte> recyclableMemoryStream = new RecyclableMemoryStream<byte>(manager, TestContext.CurrentContext.Test.Name);
...
//            var memMgr = this.GetMemoryManager();
//            var tag = "MyTag";
//            var stream = memMgr.GetStream(tag) as RecyclableMemoryStream<byte>;
//            Assert.That(stream.Capacity, Is.EqualTo(memMgr.BlockSize));
...
//            var stream = memMgr.GetStream(tag, requiredSize) as RecyclableMemoryStream<byte>;
...
//            var stream = memMgr.GetStream(tag, requiredSize, false) as RecyclableMemoryStream<byte>;
//            Assert.That(stream.Capacity, Is.AtLeast(requiredSize));
//            Assert.That(stream.Tag, Is.EqualTo(tag));

//            stream = memMgr.GetStream(tag, requiredSize, true) as RecyclableMemoryStream<byte>;
//            Assert.That(stream.Capacity, Is.AtLeast(requiredSize));
//            Assert.That(stream.Tag, Is.EqualTo(tag));
//        }
...
//            var stream = memMgr.GetStream(tag, buffer, 1, buffer.Length - 1) as RecyclableMemoryStream<byte>;
...
//        #region Test Helpers
//        protected RecyclableMemoryStream<byte> GetDefaultStream()
//        {
//            return new RecyclableMemoryStream<byte>(this.GetMemoryManager());
//        }
...
//        protected RecyclableMemoryStreamManager<byte> GetMemoryManager()
//        {
//            return new RecyclableMemoryStreamManager<byte>(DefaultBlockSize, DefaultLargeBufferMultiple,
...
//        private RecyclableMemoryStream<byte> GetRandomStream()
//        {
//            var stream = this.GetDefaultStream();
//            var buffer = this.GetRandomBuffer(stream.Capacity * 2);
//            stream.Write(buffer, 0, buffer.Length);
...
//        {
//            var stream = this.GetDefaultStream();
//            var memMgr = stream.MemoryManager<byte>;
//            var buffer = this.GetRandomBuffer(stream.MemoryManager<byte>.LargeBufferMultiple);
//            stream.Write(buffer, 0, buffer.Length);
//            stream.GetBuffer();
