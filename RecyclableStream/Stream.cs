...
namespace RecyclableStream
{
    ...
    //public abstract class Stream<T> : MarshalByRefObject, IDisposable
    //{
    //    //public static readonly Stream Null = new NullStream();
    //    //public static readonly Stream<T> Null = new NullStream();
    ...
    //    public Task CopyToAsync(Stream<T> destination)
    //    {
    ...
    //    public Task CopyToAsync(Stream<T> destination, Int32 bufferSize)
    //    {
    //        return CopyToAsync(destination, bufferSize, CancellationToken.None);
    //    }

    //    public virtual Task CopyToAsync(Stream<T> destination, Int32 bufferSize, CancellationToken cancellationToken)
    //    {
    ...
    //    private async Task CopyToAsyncInternal(Stream<T> destination, Int32 bufferSize, CancellationToken cancellationToken)
    //    {
    ...
    //    public Task<int> ReadAsync(T[] buffer, int offset, int count)
    //    {
    ...
    //    private sealed class NullStream<T> : Stream<T>
    //    {
    //        internal NullStream() { }
