...
namespace RecyclableStream
{
    ...
    //    public virtual bool CanTimeout => throw new NotImplementedException();

    //    public virtual bool CanRead => throw new NotImplementedException();

    //    public virtual bool CanSeek => throw new NotImplementedException();

    //    public virtual bool CanWrite => throw new NotImplementedException();

    //    public virtual long Length => throw new NotImplementedException();

    //    public virtual long Position { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    ...
    //    public virtual void WriteTo(MemoryStream<T> stream)
    //    {
    ...
    public class MemoryStream<T> : Stream<T>
    {
        private T[] _buffer;    // Either allocated internally or externally.
        ...
        public MemoryStream(int capacity)
        {
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(capacity), "ArgumentOutOfRange_NegativeCapacity");
            }
        ...
        public MemoryStream(T[] buffer)
            : this(buffer, true)
        {
        }

        public MemoryStream(T[] buffer, bool writable)
        {
        ...
        public MemoryStream(T[] buffer, int index, int count)
            : this(buffer, index, count, true, false)
        {
        }

        public MemoryStream(T[] buffer, int index, int count, bool writable)
            : this(buffer, index, count, writable, false)
        {
        }

        public MemoryStream(T[] buffer, int index, int count, bool writable, bool publiclyVisible)
        {
            if (buffer == null)
        ...
        public virtual bool TryGetBuffer(out ArraySegment<T> buffer)
        {
            if (!_exposable)
            {
            ...
            buffer = new ArraySegment<T>(_buffer, offset: _origin, count: (_length - _origin));
            return true;
        }
        ...
        public virtual int Capacity
        {
            ...
            set
            {
                ...
                if (value < Length) throw new ArgumentOutOfRangeException(nameof(value), "ArgumentOutOfRange_SmallCapacity");
        ...
        public override int Read([In, Out] T[] buffer, int offset, int count)
        {
            if (buffer == null)
                throw new ArgumentNullException(nameof(buffer), "ArgumentNull_Buffer");
            if (offset < 0)
        ...
        public override T Read()
        {
            ...
            if (_position >= _length) return default(T);
        ...
        public virtual void WriteTo(Stream<T> stream)
        {
            if (stream == null)
